    ...
    <div class="card">
        <div class="card-body">
            <div class="w-full md:w-8/12 m-auto">
                ...
                <x-show-table :body="[
                    ['Grade ' .($studentRecord->is_graduated == 1 ?  'Graduated from' : '') , $studentRecord->myClass?->name],
                    ['Stream '.($studentRecord->is_graduated == 1 ?  'Graduated from' : '') , $studentRecord->section?->name],
